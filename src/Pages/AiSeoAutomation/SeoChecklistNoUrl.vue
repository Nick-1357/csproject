<template>
  <div>
    <b-modal id="modal-center-seo-checklist-analytics" size="lg" centered hide-footer hide-header>
      <h5>SEO Checklist Analytics</h5>
      <!-- analytics graph here -->

      <div id="chart">
        <apexchart height="350" :options="chosenAnalytics.chartOptions" :series="chosenAnalytics.series"></apexchart>
      </div>
    </b-modal>

    <b-modal id="modal-center-seo-checklist-analytics-second" size="lg" centered hide-footer hide-header>
      <h5>SEO Checklist Analytics</h5>
      <!-- analytics graph here -->

      <div id="chart">
        <apexchart height="350" :options="chosenAnalytics.chartOptionsSecond" :series="chosenAnalytics.seriesSecond"></apexchart>
      </div>
    </b-modal>

    <div id="bodyfix__content__seochecklist" class="bodyfix__content__seochecklist">
      <div class="seochecklist__dropdown__group" v-for="(data, index) in seo_checklist" :key="'seo_checklist' + index">
        <div class="seochecklist__dropdown__title d-flex" type="button">
          ...
          <div class="seochecklist__dropdown__title__right">
            <button v-if="index != 'keyword_prominence' && index != 'url'" class="btn btn-primary d-flex align-items-center me-2" @click="viewSeoChecklistAnalytics(data)">
              <span class="material-icons-outlined me-2">bar_chart</span>Analytics
            </button>

            <button v-if="index == 'h2_h6' || index == 'p'" class="btn btn-primary d-flex align-items-center" @click="viewSeoChecklistAnalyticsSecond(data)">
              <span class="material-icons-outlined me-2">bar_chart</span>Analytics
            </button>
            <button class="btn-primary ms-2 btn-arrow-icon" v-b-toggle="'seo_checklist_' + index">
          ...
          <div class="seochecklist__dropdown__content pt-5">
            ...
            <div class="row w-100">
              ...
              <div v-if="index == 'title'" class="col-6">
                <div class="seochecklist__card w-100 yellow">It's optimal to have maximum 60 characters in your webpage</div>
              </div>
              <div v-if="index == 'title'" class="col-6">
                <div class="seochecklist__card w-100 yellow">
                  It's optimal to have 1 target keyword in the
                  {{ index }} (Exact match)
                </div>
              </div>

              <div v-if="index == 'description'" class="col-6">
                <div class="seochecklist__card yellow">It's optimal to have maximum 160 characters in your webpage</div>
              </div>
              <div v-if="index == 'description'" class="col-6">
                <div class="seochecklist__card yellow">
                  It's optimal to have 1 target keyword in the
                  {{ index }} (Exact match)
                </div>
              </div>
              ...
              <div v-if="index == 'h1'" class="col-6">
                <div class="seochecklist__card yellow">It's optimal to have exactly one H1 element in your webpage</div>
              </div>
              <div v-if="index == 'h1'" class="col-6">
                <div class="seochecklist__card yellow">
                  It's optimal to have 1 target keyword in the
              ...
              <div v-if="index == 'h2_h6'" class="col-6">
                <div class="seochecklist__card yellow">
                  It's optimal to have
                  {{ seo_checklist[index].web_sorted[3] }} to {{ seo_checklist[index].web_sorted[6] }} elements
                </div>
              </div>

              <div class="col-6" v-if="index == 'internal_links' || index == 'external_links'">
                <div class="seochecklist__card yellow">
                  It's optimal to have
                  {{ seo_checklist[index].link_sorted[3] }} to {{ seo_checklist[index].link_sorted[6] }} elements
                </div>
              </div>
              ...
              <div v-if="index == 'keyword_prominence' || index == 'url'" class="col-6">
                <div class="seochecklist__card yellow">
                  It's optimal to have 1 target keyword in the
                  {{ index }} (Exact match)
                </div>
            ...
            <div v-if="index == 'title' || index == 'description'" class="seochecklist__table mt-4">
              <table class="nextable__AiSeoAutomation mt-4">
                <thead>
                  <tr>
                ...
                <tbody v-for="(details, index_website) in data.website_matchlist" :key="'website_matchlis' + index_website">
                  <tr class="bb-grey">
                    <td class="br-grey fw-600 nowrap" rowspan="2">{{ websiteName[index_website] }}</td>
                    <td>Website</td>
                    <td>{{ details[0] }}</td>
                    <td>
                      <span class="elements" :key="'details_1' + index_val" v-for="(val, index_val) in details[1]">{{ val }}</span>
                    </td>
                    <td>
                      <span class="keywords" :key="'details_2' + index_val" v-for="(val, index_val) in details[2]">{{ val }}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>Google</td>
                    ...
                    <td>
                      <span class="elements" :key="'google_matchlist' + index_val" v-for="(val, index_val) in data.google_matchlist[index_website][1]">{{ val }} <br /> </span>
                    </td>
                    <td>
                      <span class="keywords" :key="'google_matchlist' + index_val" v-for="(val, index_val) in data.google_matchlist[index_website][2]">{{ val }} <br /> </span>
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <!-- <div class="row seochecklist__thead g-0">
                ...
                <div class="col-3">
                  <span class="col-title">Characters</span>
                  <button class="material-icons-outlined btn-orderby">arrow_upward</button>
                </div>
                <div class="col-2">
              ...
              <div class="row seochecklist__tbody g-0" v-for="(details, index_website) in data.website_matchlist" :key="'website_matchlis' + index_website">
                ...
                <div class="col-3 border-left-grey">
                  <div class="sub-row-1 d-flex">
                    <span>Website</span>
                ...
                <div class="col-2">
                  ...
                  <div class="sub-row-2">
                    <span>{{ data.google_matchlist[index_website][0] }} 111</span>
                  </div>
                </div>

                <div class="col-3">
                  <div class="sub-row-1">
                    <span :key="'details_1' + index_val" v-for="(val, index_val) in details[1]">{{ val }}</span>
                  </div>
                  <div class="sub-row-2">
                    <span :key="'google_matchlist' + index_val" v-for="(val, index_val) in data.google_matchlist[index_website][1]">{{ val }}</span>
                  </div>
                </div>
                <div class="col-2">
                  <div class="sub-row-1">
                    <span :key="'details_2' + index_val" v-for="(val, index_val) in details[2]">{{ val }}</span>
                  </div>
                  <div class="sub-row-2">
                    <span :key="'google_matchlist_2' + index_val" v-for="(val, index_val) in data.google_matchlist[index_website][2]">{{ val }}</span>
                  </div>
                </div>
              </div> -->
            </div>
            ...
            <div v-if="index == 'keyword_prominence' || index == 'url'" class="seochecklist__table mt-4">
              <table class="nextable__AiSeoAutomation">
                ...
                <tbody v-for="(details, index_website) in data.website_matchlist" :key="'website_matchlis' + index_website">
                  <tr class="bb-grey">
                    <td class="br-grey fw-600 nowrap">{{ websiteName[index_website] }}</td>
                    <td>Website</td>
                    <td>{{ details[0] }}</td>
                    <td>
                      <span class="elements" :key="'details_1' + index_val" v-for="(val, index_val) in details[1]">{{ val }} <br /> </span>
                    </td>
                    <td>
                      <span class="keywords" :key="'details_1' + index_val" v-for="(val, index_val) in details[2]">{{ val }} <br /> </span>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div v-if="index == 'h1'" class="seochecklist__table mt-4">
              <table class="nextable__AiSeoAutomation">
                <thead>
                  <tr>
                    <th class="w-15">Website</th>
                ...
                <tbody v-for="(details, index_website) in data.website_matchlist" :key="'website_matchlis' + index_website">
                  <tr class="bb-grey">
                    ...
                    <td>{{ details[0] }}</td>
                    <td>
                      <span class="elements" :key="'details1' + index_val" v-for="(val, index_val) in details[1][0]">{{ val }} <br /> </span>
                    </td>
                    <td class="keywords_string">
                      <span :key="'details1' + index_val" v-for="(val, index_val) in details[2][0]">{{ val }}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div v-if="index == 'img_alt'" class="seochecklist__table mt-5">
              ...
              <div class="card p-2">
                <ol>
                  <li class="p-1" v-for="(tr, index) in seo_checklist[index].suggested_img_alt" :key="(tr, index)">
                    <span>{{ tr }}</span>
                  </li>
                </ol>
              </div>
            ...
            <div v-if="index == 'external_links' || index == 'internal_links'" class="seochecklist__table mt-5">
              <!-- inside a tab-->
              <div class="row seochecklist__thead g-0">
                <div class="col-2">
              ...
              <div class="card p-2">
                <ol>
                  <li class="p-1" v-for="(tr, index) in seo_checklist[index].suggested_anchor_text" :key="(tr, index)">
                    <span>{{ tr }}</span>
                  </li>
                </ol>
              </div>
...
export default {
  ...
  methods: {
    viewSeoChecklistAnalytics(data) {
      var me = this;
      me.chosenAnalytics = data;
      console.log(me.chosenAnalytics);
      this.$bvModal.show("modal-center-seo-checklist-analytics");
    },
    viewSeoChecklistAnalyticsSecond(data) {
      this.chosenAnalytics = data;
      console.log(this.chosenAnalytics);
  ...
  created() {
    ...
    const seo_checklist_result = this.values.find((element) => element.slug === "seo_checklist");
        ...
        for (const [key_2, value_2] of Object.entries(value)) {
          ...
          if (key_2 == "number_of_images") {
            ...
            value_2.forEach((element, index_ele) => {
              ...
              link_sorted.push(element + this.seo_checklist[key].number_of_images_noalt[index_ele]);
            });
              ...
              chart: {
                ...
                events: {
                  dataPointSelection: (series, seriesIndex, dataPointIndex) => {
                    ...
                    this.show_element = this.seo_checklist[key].series[dataPointIndex.seriesIndex].content[dataPointIndex.dataPointIndex];
                ...
                yaxis: [
                  {
                    ...
                    label: {
                      borderColor: "#1565C0",
                      text: `Website length Range` + ` [ ` + web_sorted[3] + ` - ` + web_sorted[6] + ` ]`,
                    },
                  },
                ],
              },
                ...
                yaxis: [
                  {
                    ...
                    label: {
                      borderColor: "#80b1d3",
                      text: `Website Words Range` + ` [ ` + word_sorted[3] + ` - ` + word_sorted[6] + ` ]`,
                    },
                  },
                ],
              },
                ...
                yaxis: [
                  {
                    ...
                    label: {
                      borderColor: "#1565C0",
                      text: `Link length Range` + ` [ ` + link_sorted[3] + ` - ` + link_sorted[6] + ` ]`,
                    },
                  },
                ],
              },
    ...
    const user_seo_checklist_result = this.values.find((element) => element.slug === "user_seo_checklist");
    ...
    if (user_seo_checklist_result != undefined) {
      ...
      for (const [key, value] of Object.entries(this.user_seo_checklist)) {
        ...
        if (key == "title" || key == "description") {
            ...
            for (const [key_2, value_2] of Object.entries(value[0])) {
              ...
              if (key_2 == "google_chars") {
                ...
                this.seo_checklist[key].series.forEach((element) => {
                  if (element.name == "Google Characters") {
                    element.data.push(value_2);
                    element.content.push(this.user_seo_checklist[key][0].google);
                  }
                });
              }
              ...
              if (key_2 == "website_chars") {
                ...
                this.seo_checklist[key].series.forEach((element) => {
                  if (element.name == "Website Characters") {
                    element.data.push(value_2);
                    element.content.push(this.user_seo_checklist[key][0].website);
                  }
                });
              }
          ...
          if (value.website == undefined) {
            this.seo_checklist[key].chartOptionsSecond.xaxis.categories.push("You");
            ...
            if (key_2 == "number_of_links") {
              this.seo_checklist[key].series.forEach((element) => {
                if (element.name == "Number of links") {
                  element.data.push(value_2);
                  element.content.push(this.user_seo_checklist[key].number_of_links);
                }
              });
            }
          }
            ...
            if (key_2 == "number_of_images") {
              this.seo_checklist[key].series.forEach((element) => {
                if (element.name == "Number of images") {
                  element.data.push(value_2);
                  element.content.push(this.user_seo_checklist[key].number_of_images);
                }
              });
            }
            ...
            if (key_2 == "number_of_images_noalt") {
              this.seo_checklist[key].series.forEach((element) => {
                if (element.name == "Number of images noalt") {
                  element.data.push(value_2);
                  element.content.push(this.user_seo_checklist[key].number_of_images_noalt);
                }
              });
            }
          }
...
.seochecklist__dropdown__icon__left .tick {
  color: grey;
  font-size: 55px;
  text-align: start;
}
...
.seochecklist__dropdown__title__right .btn-arrow-icon[aria-expanded="false"] .arrow-icon {
  transform: rotate(0deg);
  transition: 0.4s ease-out;
  color: #2c8de0;
}
.seochecklist__dropdown__title__right .btn-arrow-icon[aria-expanded="true"] .arrow-icon {
